...
plot(
    ...
    #col = c("#00CD005D", "#0000CD5D")[(swiss$Catholic > 50) + 1] 
    #col = c("#00CD005D", "#0000CD5D")[as.factor(swiss$Catholic > 50)] 
    #col = purrr::map_chr(swiss$Catholic, function(x) switch( (x > 50) + 1,  "#00CD005D", "#0000CD5D"))
    col = purrr::map_chr(swiss$Catholic, function(x) switch( (x > 50) + 1,  "#00CD005D", "#0000CD5D"))
)
# tb1_ende
